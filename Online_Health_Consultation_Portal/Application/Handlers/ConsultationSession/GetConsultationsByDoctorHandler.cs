...
{
    public class GetConsultationsByDoctorHandler : IRequestHandler<GetConsultationsByDoctorQuery, List<ConsultationSessionDto>>
    {
        private readonly AppDbContext _context;
        private readonly IAutoMapper _mapper;
        public GetConsultationsByDoctorHandler(AppDbContext context, IAutoMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
